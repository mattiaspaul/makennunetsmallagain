...
class Faster(torch.nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        x = self.relu(self.cout(self.norm(torch.cat((y,z),1))))
...
class nnUNetTrainerV2_noMirroring_faster_bn(nnUNetTrainer):
    """
        ...
        for name, module in self.network.named_modules():
            if isinstance(module,ConvDropoutNormNonlin):
                ...
                if(before.conv.out_channels>=160):
                    ...
                    block1 = Faster(dim1,dim2,before.conv.stride,4)
